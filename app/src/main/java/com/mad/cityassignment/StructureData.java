...
{
    public static final int[] RESIDENTIALS = {
        0, // No structure
    ...
    public StructureData(int res, int com, int road, int misc) {

        this.structureList = Arrays.asList(new Structure[] {
                new Structure(R.drawable.ic_building1, "Residential 1", res),
                new Structure(R.drawable.ic_building2, "Residential 2", res),
                new Structure(R.drawable.ic_building3, "Residential 3", res),
                new Structure(R.drawable.ic_building4, "Residential 4", res),
                new Structure(R.drawable.ic_building5, "Commercial 1", com),
                new Structure(R.drawable.ic_building6, "Commercial 2", com),
                new Structure(R.drawable.ic_building7, "Commercial 3", com),
                new Structure(R.drawable.ic_building8, "Commercial 4", com),
                ...
                new Structure(R.drawable.ic_tree1, "Tree", misc),
                new Structure(R.drawable.ic_tree2, "Tree", misc),
                new Structure(R.drawable.ic_tree3, "Tree", misc),
                new Structure(R.drawable.ic_tree4, "Tree", misc),
        });
